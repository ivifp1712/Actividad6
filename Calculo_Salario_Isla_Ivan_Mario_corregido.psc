Funcion salario(salarioBrutof, tipoContrato, edad, paga)
	...
	salarioNeto <- salarioBruto -(salarioBruto*tipoCotizacion)-(salarioBruto*tipoIRPF) + boni
	...
	Escribir "Bonficación de: ", boni
	Escribir "Líquido a percibir mensual ", redon(salarioNeto)
FinFuncion
